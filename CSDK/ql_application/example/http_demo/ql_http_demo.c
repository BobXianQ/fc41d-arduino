...
static void ql_https_demo_thread(void * arg)
{
       ...
       ql_demo_sta_app_init("quectel", "12345678");
   do
   {
...
#if HTTP_GET_DEMO
webclient_get_smpl("http://www.rt-thread.com/service/rt-thread.txt",get_cb);
