...
#define SPI_DATA_WIDH_8   (0<<4)								/* SPI data widh 8 */
#define SPI_DATA_WIDH_16    (1<<4)								/* SPI data widh 16 */
...
#define SPI_MODE_1       (SPI_CPOL | 0)              /* CPOL = 0, CPHA = 1 */
#define SPI_MODE_2       (0 | SPI_CPHA)              /* CPOL = 1, CPHA = 0 */
